...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT sinif, COUNT(islem.kitapno) AS kitap_sayisi FROM ogrenci JOIN islem ON ogrenci.ogrno = islem.ogrno WHERE sinif IN ('10A', '10B') GROUP BY sinif";
    @Query(value = QUESTION_4, nativeQuery = true)
    List<KitapCount> findClassesWithBookCount();

    //Öğrenci tablosundaki öğrenci sayısını gösterin
    String QUESTION_5 = "SELECT COUNT(*) AS toplam_ogrenci FROM ogrenci";
    ...
    String QUESTION_9 = "SELECT o.ad, o.soyad, COUNT(i.kitapno) AS kitap_sayisi FROM ogrenci o JOIN islem i ON o.ogrno = i.ogrno GROUP BY o.ad, o.soyad";
